                        ...
                        <div key={tab.value}>
                            ...
                            <div className="tw-p-4 tw-bg-[#1E1E1E]">
                                <Editor
                                    ...
                                    value={code?.[tab.value as "html" | "css" | "javascript"] || ""}
                ...
                <div className="tw-flex-1 tw-border tw-flex tw-flex-col">
                    <div className="tw-bg-[#1e1e1e] tw-text-white tw-flex tw-justify-between tw-px-4 tw-py-2 tw-rounded-tl tw-rounded-tr">
                        ...
                        <div className="tw-flex tw-items-center tw-gap-4">
                            <div className="tw-flex tw-items-center tw-gap-2">
                                ...
                                <InputSwitch checked={live.js} onChange={(e) => setLive({ ...live, js: e.value })} />
                            </div>
                            <div className="tw-flex tw-items-center tw-gap-2">
                                <div className="tw-font-bold">Live HTML</div>
                                <InputSwitch checked={live.htmlCss} onChange={(e) => setLive({ ...live, htmlCss: e.value })} />
                            </div>
                        </div>
                    </div>
                    <iframe ref={iframeRef} className="tw-flex-1"></iframe>
                    ...
                    <div className="tw-mt-4">
                        <div className="bg-primary tw-px-4 tw-py-2 tw-rounded-tl tw-rounded-tr tw-flex tw-items-center">
                            ...
                            <i onClick={() => setIframeLogs([])} className="tw-cursor-pointer pi pi-ban tw-ml-2"></i>
                        </div>
                        <div
                        ...
                        >
                            {iframeLogs.length > 0 ? (
                                iframeLogs.map((log, index) => (
                                    <div key={index} style={{ whiteSpace: "pre-wrap", marginBottom: "5px" }}>
                                        {log}
                                    </div>
                                ))
                            ) : (
